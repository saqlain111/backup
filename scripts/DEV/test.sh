...
-d "$(printf '{"macId": "%s", "namespaceId": "%s"}' "$MAC" "TEST_123")"
)
# Display the output
...
# echo "$image"
       ...
       # sudo docker rmi modus.clouzer.com:5443/$image:$systemver-$arch-$hubtype-$os-dev
        ...
        sudo docker pull modus.clouzer.com:5443/soulhub:$hubver-$arch-$hubType-$hubos-test
        sudo docker tag modus.clouzer.com:5443/soulhub:$hubver-$arch-$hubType-$hubos-test soulhub
        sudo docker rmi modus.clouzer.com:5443/soulhub:$hubver-$arch-$hubType-$hubos-test
   
        sudo docker pull modus.clouzer.com:5443/portal:$portalver-$arch-$hubType-$hubos-test
        sudo docker tag modus.clouzer.com:5443/portal:$portalver-$arch-$hubType-$hubos-test portal
        sudo docker rmi modus.clouzer.com:5443/portal:$portalver-$arch-$hubType-$hubos-test
   
        sudo docker pull modus.clouzer.com:5443/pyprocess:$pyver-$arch-$hubType-$hubos-test
        sudo docker tag modus.clouzer.com:5443/pyprocess:$pyver-$arch-$hubType-$hubos-test pyprocess
        sudo docker rmi modus.clouzer.com:5443/pyprocess:$pyver-$arch-$hubType-$hubos-test
   
        sudo docker pull modus.clouzer.com:5443/souldapi:$souldapiver-$arch-$hubType-$hubos-test
        sudo docker tag modus.clouzer.com:5443/souldapi:$souldapiver-$arch-$hubType-$hubos-test souldapi
        sudo docker rmi modus.clouzer.com:5443/souldapi:$souldapiver-$arch-$hubType-$hubos-test
...
echo "========================================================>"
echo $image
        sudo docker pull modus.clouzer.com:5443/$image:$systemver-$arch-$hubtype-$hubos-test
        sudo docker tag modus.clouzer.com:5443/$image:$systemver-$arch-$hubtype-$hubos-test $image
        sudo docker rmi modus.clouzer.com:5443/$image:$systemver-$arch-$hubtype-$hubos-test
        done
